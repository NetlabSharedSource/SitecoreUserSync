...
{
    public class DbUsersTableColumnHandler : BaseFieldStorageHandler
    {
        public DbUsersTableColumnHandler()
        {
            UserKeyStorage = new MobileAliasUserKeyStorage();
        }

        public DbUsersTableColumnHandler(bool checkThatCustomPropertyExist): base(checkThatCustomPropertyExist)
        {
            UserKeyStorage = new MobileAliasUserKeyStorage();
        }
